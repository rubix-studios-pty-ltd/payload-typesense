...
## [1.6.13](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.12...v1.6.13) (2026-09-18)


### Bug Fixes

* **dep:** security patch payload ([ce5ab47](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/ce5ab478672e4553738f357004d8b504e509bbb6))

## [1.6.12](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.11...v1.6.12) (2026-07-14)


### Bug Fixes

* remove type import for React in HeadlessSearchInput and ThemeProvider components ([ff217eb](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/ff217eb22995905f78aa731e3b7d7bc3bed66de8))
...
* improve keyboard handling by ensuring active element is checked before determining current index ([ae66edc](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/ae66edc0c7014a7ccc22958795738da19e0dc27d))

## [1.6.9](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.8...v1.6.9) (2026-07-04)


### Bug Fixes

* simplify GitHub release configuration in .releaserc.json ([7cb252f](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/7cb252f3a22461529b8d6ed1dc02f829994c5b4c))
...
* trigger patch release ([89be9ab](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/89be9ab48bee42b1a3fa413b3df7b2bda64d0377))

## [1.6.5](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.4...v1.6.5) (2026-05-22)


### Bug Fixes

* consolidate React import statement in ThemeProvider component ([259acf0](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/259acf0809c1f9261cc042bc36bcce810cf1baa6))
* update import statements to consolidate React import and adjust linter settings ([cb59a1a](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/cb59a1ad829c8c82bebfe7130e440ec2830fec38))
...
* **release:** update branch name from 'development' to 'dev' ([bcf2c60](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/bcf2c6047a08a780b6884583068d55b8fcfdc0b0))

## [1.6.2](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.1...v1.6.2) (2026-04-22)


### Bug Fixes

* **ci:** correct semantic-release plugin configuration ([06b836d](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/06b836d21b2b236fd2718e746820e2098a0b0100))

## [1.6.1](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.6.0...v1.6.1) (2026-04-21)


### Bug Fixes

* **axios:** upstream axios dep pinning ([ef51a43](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/ef51a431a77c2a010366cb8739847d44b5b2ac43))

# [1.6.0](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.5.5...v1.6.0) (2026-04-19)


### Bug Fixes

* **release:** trigger patch release ([c288d1c](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/c288d1c8f4d3789e70712946d07625b610c884b7))


### Features

* **typesense:** pin version upstream axios ([b0988c6](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/b0988c6bbb93227680f9594ab2fe65a7557a5040))

## [1.5.5](https://github.com/rubix-studios-pty-ltd/payload-typesense/compare/v1.5.4...v1.5.5) (2026-03-29)


### Bug Fixes

* improve type checking in syncExistingDocuments and update tsconfig settings ([d2bb912](https://github.com/rubix-studios-pty-ltd/payload-typesense/commit/d2bb9124b2601e8c4c51e2419c7c151533959c8f))
