...
const CacheConfigSchema = z.object({
	...
	ttl: z
		.number()
		.int()
		.min(1000, "TTL must be at least 1000ms")
		.optional()
...
export const TypesenseSearchConfigSchema = z.object({
	...
	typesense: z.object({
		...
		nodes: z
			.array(TypesenseNodeSchema)
			.min(1, "At least one Typesense node is required"),
...
export type ValidatedTypesenseSearchConfig = z.infer<
	typeof TypesenseSearchConfigSchema
>
